...
function Menu_RegisterAlch( category, alch )
	if !SGS.Alch[category] then SGS.Alch[category] = {} end
...
local ALCH = {}
ALCH.material = "vgui/fish/cooked_herring.png"
ALCH.title = "Burn cooked herring"
ALCH.stitle = "Burn cooked herring"
ALCH.uid = "burn1"
ALCH.description = "Burn a cooked herring."
ALCH.cost = { cooked_herring = 1}
ALCH.reqlvl = { alchemy = 1, cooking = 1}
ALCH.gives = { burned_fish = 1}
ALCH.xp = 10
Menu_RegisterAlch( "Fish Burning", ALCH )

local ALCH = {}
ALCH.material = "vgui/fish/cooked_trout.png"
ALCH.title = "Burn cooked trout"
ALCH.stitle = "Burn cooked trout"
ALCH.uid = "burn2"
ALCH.description = "Burn a cooked trout."
ALCH.cost = { cooked_trout = 1}
ALCH.reqlvl = { alchemy = 1, cooking = 1}
ALCH.gives = { burned_fish = 1}
ALCH.xp = 10
Menu_RegisterAlch( "Fish Burning", ALCH )
...
local ALCH = {}
ALCH.material = "vgui/fish/cooked_cod.png"
ALCH.title = "Burn cooked cod"
ALCH.stitle = "Burn cooked cod"
ALCH.uid = "burn3"
ALCH.description = "Burn a cooked cod."
ALCH.cost = { cooked_cod = 1}
ALCH.reqlvl = { alchemy = 2, cooking = 10}
ALCH.gives = { burned_fish = 1}
ALCH.xp = 20
Menu_RegisterAlch( "Fish Burning", ALCH )

local ALCH = {}
ALCH.material = "vgui/fish/cooked_salmon.png"
ALCH.title = "Burn cooked salmon"
ALCH.stitle = "Burn cooked salmon"
ALCH.uid = "burn4"
ALCH.description = "Burn a cooked salmon."
ALCH.cost = { cooked_salmon = 1}
ALCH.reqlvl = { alchemy = 2, cooking = 15}
ALCH.gives = { burned_fish = 1}
ALCH.xp = 20
Menu_RegisterAlch( "Fish Burning", ALCH )

local ALCH = {}
ALCH.material = "vgui/fish/cooked_tuna.png"
ALCH.title = "Burn cooked tuna"
ALCH.stitle = "Burn cooked tuna"
ALCH.uid = "burn5"
ALCH.description = "Burn a cooked tuna."
ALCH.cost = { cooked_tuna = 1}
ALCH.reqlvl = { alchemy = 3, cooking = 20}
ALCH.gives = { burned_fish = 1}
ALCH.xp = 30
Menu_RegisterAlch( "Fish Burning", ALCH )

local ALCH = {}
ALCH.material = "vgui/fish/cooked_lobster.png"
ALCH.title = "Burn cooked lobster"
ALCH.stitle = "Burn cooked lobster"
ALCH.uid = "burn6"
ALCH.description = "Burn a cooked lobster."
ALCH.cost = { cooked_lobster = 1}
ALCH.reqlvl = { alchemy = 3, cooking = 30}
ALCH.gives = { burned_fish = 1}
ALCH.xp = 30
Menu_RegisterAlch( "Fish Burning", ALCH )

local ALCH = {}
ALCH.material = "vgui/fish/cooked_bass.png"
ALCH.title = "Burn cooked bass"
ALCH.stitle = "Burn cooked bass"
ALCH.uid = "burn7"
ALCH.description = "Burn a cooked bass."
ALCH.cost = { cooked_bass = 1}
ALCH.reqlvl = { alchemy = 4, cooking = 40}
ALCH.gives = { burned_fish = 1}
ALCH.xp = 40
Menu_RegisterAlch( "Fish Burning", ALCH )

local ALCH = {}
ALCH.material = "vgui/fish/cooked_swordfish.png"
ALCH.title = "Burn cooked swordfish"
ALCH.stitle = "Burn cooked swordfish"
ALCH.uid = "burn8"
ALCH.description = "Burn a cooked swordfish."
ALCH.cost = { cooked_swordfish = 1}
ALCH.reqlvl = { alchemy = 4, cooking = 50}
ALCH.gives = { burned_fish = 1}
ALCH.xp = 40
Menu_RegisterAlch( "Fish Burning", ALCH )

local ALCH = {}
ALCH.material = "vgui/fish/cooked_shark2.png"
ALCH.title = "Burn cooked shark"
ALCH.stitle = "Burn cooked shark"
ALCH.uid = "burn9"
ALCH.description = "Burn a cooked shark."
ALCH.cost = { cooked_shark = 1}
ALCH.reqlvl = { alchemy = 5, cooking = 60}
ALCH.gives = { burned_fish = 1}
ALCH.xp = 50
Menu_RegisterAlch( "Fish Burning", ALCH )

local ALCH = {}
ALCH.material = "vgui/fish/cooked_eel.png"
ALCH.title = "Burn cooked eel"
ALCH.stitle = "Burn cooked eel"
ALCH.uid = "burn10"
ALCH.description = "Burn a cooked eel."
ALCH.cost = { cooked_eel = 1}
ALCH.reqlvl = { alchemy = 5, cooking = 71}
ALCH.gives = { burned_fish = 1}
ALCH.xp = 50
Menu_RegisterAlch( "Fish Burning", ALCH )
