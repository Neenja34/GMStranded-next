	...
	for k, v in pairs(ents.FindByClass("npc_gman")) do
		...
		if trace.HitWorld then
			...
			if tdist <= 600 then
				...
				if v != LocalPlayer() then
					draw.SimpleTextOutlined( "The President", "SGS_HUD3", pos.x, pos.y - 25, Color(100,200,200,255), textalign, 1,1,Color(0,0,0,255))
					draw.SimpleTextOutlined("[Quest Rewards]", "SGS_HUD3", pos.x, pos.y - 10, Color(100,200,200,255),textalign,1,1,Color(0,0,0,255))
				end
			elseif tdist > 600 and tdist <= 2000 then
