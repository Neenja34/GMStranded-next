...
function PANEL:Paint()
	...
	draw.RoundedBoxEx( 8, 4, 4, self:GetWide()-8, self:GetTall()-8, Color( 0, 0, 0, 255 ), true, true, true, true )
		...
		draw.SimpleText( "Set Station", "ScoreboardText", 50, 355, Color(255,255,255,255), 0, 0 )
		...
		--[[ draw.SimpleText( "Go to https://directory.shoutcast.com/ and find the station", "RadioSmallText", 8, 400, Color(255,200,200,255), 0, 0 )
		draw.SimpleText( "you want to play. Download the m3u and open it", "RadioSmallText", 8, 410, Color(255,200,200,255), 0, 0 )
		draw.SimpleText( "with notepad. Copy the link for the station.", "RadioSmallText", 8, 420, Color(255,200,200,255), 0, 0 )
		draw.SimpleText( "And put it in here.", "RadioSmallText", 8, 430, Color(255,200,200,255), 0, 0 )
