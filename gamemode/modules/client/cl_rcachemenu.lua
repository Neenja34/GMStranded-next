...
function PANEL:Paint( w, h )
	...
	surface.DrawRect( x, y, wide / 2 - 25, tall ) --Outer Left
	surface.DrawRect( x + 4, y + 4, wide / 2 - 33, tall - 8 ) --Inner Left

	surface.DrawRect( wide / 2 + 25, y, 300, tall ) --Outer Right
	surface.DrawRect( wide / 2 + 29, y + 4, 292, tall - 8) --Inner Right
...
function PANEL:DrawFrame()
	...
	RCacheTitle:SetPos( 45, 7 ) -- Position
	...
	RCacheLimitLabel:SetPos( 12, 576 ) -- Position
	...
	YourInventoryTitle:SetPos( 445, 7 ) -- Position
	...
	YourInventoryLimitLabel:SetPos( 362, 576 ) -- Position
	...
	concommand.Add( "sgs_refreshrcachelist", function()
		if !IsValid( CacheInventory ) then return end
...
function PANEL:DrawFrame()
	...
	TransferButton.DoClick = function( TransferButton )
		...
		elseif SGS.ctype == "pm" then
			net.Start( "cl_topcachemeteoric" ) net.WriteString( SGS.temprType ) net.WriteInt( tonumber( TextEntry:GetValue() ), 16 ) net.SendToServer()
...
function DClickTransfer( rType, rAmt )
	...
	elseif SGS.ctype == "pm" then
		net.Start( "cl_frompcachemeteoric" ) net.WriteString( rType ) net.WriteInt( tonumber( rAmt ), 16 ) net.SendToServer()
	elseif SGS.ctype == "tribe" then
...
function DClickTransfer2( rType, rAmt )
	...
	elseif SGS.ctype == "pm" then
		net.Start( "cl_topcachemeteoric" ) net.WriteString( rType ) net.WriteInt( tonumber( rAmt ), 16 ) net.SendToServer()
	elseif SGS.ctype == "tribe" then
...
function PANEL:DrawFrame()
	...
	TransferButton.DoClick = function( TransferButton )
		...
		elseif SGS.ctype == "pm" then
			net.Start( "cl_frompcachemeteoric" ) net.WriteString( SGS.temprType ) net.WriteInt( tonumber( TextEntry:GetValue() ), 16 ) net.SendToServer()
		elseif SGS.ctype == "tribe" then
