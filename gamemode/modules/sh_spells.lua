...
SPELL.description = "Summons a bloodmoon."
SPELL.cost = { cosmic_stone = 20, chaos_stone = 20, nature_stone = 20, cloth = 30 }
SPELL.reqlvl = 80
SPELL.exp = 1000
SPELL.material = "vgui/spells/new/setdawn.png"
SPELL.spell = "apocalypse"
Menu_RegisterSPell( SPELL )
...
SPELL = {}
SPELL.name = "Fix leg: Self"
SPELL.description = "Fixes your leg."
SPELL.cost = { water_stone = 1, nature_stone = 2, earth_stone = 1 }
SPELL.reqlvl = 10
SPELL.exp = 15
SPELL.material = "vgui/spells/new/healself.png"
SPELL.spell = "fixself"
...
SPELL = {}
SPELL.name = "Fix Leg: Other"
SPELL.description = "Fixes someone else's leg."
SPELL.cost = { water_stone = 1, nature_stone = 2, earth_stone = 1 }
SPELL.reqlvl = 15
SPELL.exp = 60
SPELL.material = "vgui/spells/new/healother.png"
SPELL.spell = "fixother"
Menu_RegisterSPell( SPELL )
