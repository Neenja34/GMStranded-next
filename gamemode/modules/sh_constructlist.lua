...
function Menu_RegisterStructure( category, recipe )
	if !SGS.structures[category] then SGS.structures[category] = {} end
...
RECIPE = {}
RECIPE.model = "models/MaxOfS2D/hover_rings.mdl"
RECIPE.title = "Meteoric Persistent Cache"
RECIPE.description = "Stores resources across sessions!\nCapacity: 6000"
RECIPE.cost = { refined_meteoric_iron = 5, void_cache = 20 }
RECIPE.reqlvl = { construction = 70 }
RECIPE.ent = "gms_pcachemeteoric"
RECIPE.spawntime = 6
RECIPE.xp = 10000
Menu_RegisterStructure( "cache", RECIPE )
...
RECIPE = {}
RECIPE.model = "models/props_combine/combine_mine01.mdl"
RECIPE.title = "Refined Auto Miner"
RECIPE.description = "This device will not break, and has a larger self inventory!"
RECIPE.cost = { meteoric_iron = 10, platinum = 20, palm_wood = 20 }
RECIPE.reqlvl = { construction = 65 }
RECIPE.ent = "gms_miner_nobreak"
RECIPE.spawntime = 3
RECIPE.xp = 15000
Menu_RegisterStructure( "meteoric", RECIPE )