function SGS_SetUpTablesShared()
	...
	SGS.VortChatMessages = {
		"Come find me at spawn, I've got loads of hot deals!",
		"Try and not eat the berries.. I hear they're sometimes deadly.",
		"Did you find a Void Cache? I will sell you the crystal to open it. Only 750 GTokens!",
		"I sell lots of useful stuff, but my buddy Dr.K in island world sells hats!",
		"In case of emergency, I've usually got a pretty steady supply of fruit berries growing at spawn. Help yourself!",
	...
	SGS.cache_entities = { "gms_rcache", "gms_pcache", "gms_pcache2", "gms_pcache3", "gms_pcache4", "gms_pcacheboss", "gms_pcachemeteoric","gms_tribecache" }
end