...
function SGS_ClaimShopNPC2()
	...
	for _, v in pairs(ents.FindByClass("npc_gman")) do
		...
		SGS.shopent4:AddRelationship("npc_headcrab_fast D_LI 99")
		SGS.shopent4:AddRelationship("npc_headcrab_black D_LI 99")
		SGS.shopent4:AddRelationship("npc_zombie D_LI 99")
		SGS.shopent4:AddRelationship("npc_strider D_LI 99")
		SGS.shopent4:AddRelationship("npc_kleiner D_LI 99")
		return
	end
	timer.Simple(5, SGS_ClaimShopNPC2)
end
timer.Simple(5, SGS_ClaimShopNPC2)
