...
SGS.maxplants = 0
SGS.ach = SGS.ach or {}
SGS.sideinventoryposx = ScrW() - 256
...
function SGS_OpenRules()

	SGS.TOS = vgui.Create("new_menu")
	SGS.TOS:SetVisible(true)
	SGS.TOS:MakePopup()
	GAMEMODE.NewMenu.btn_option4:OnMousePressed()

end
concommand.Add( "sgs_rules", SGS_OpenRules )
...
function SGS_OpenSContent()

	SGS.TOS = vgui.Create("new_menu")
	SGS.TOS:SetVisible(true)
	SGS.TOS:MakePopup()
	GAMEMODE.NewMenu.btn_option5:OnMousePressed()
end
concommand.Add( "sgs_scontent", SGS_OpenSContent )
...
net.Receive( "sgs_receiveqtoken", function( length )
...
function GM:OnPlayerChat( player, strText, bTeamOnly, bPlayerIsDead )
	...
	if ( IsValid( player ) ) then
		-- local p_group = player:GetUserGroup()
