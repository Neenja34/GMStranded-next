...
--	["voiddonator"] = { name = "Void Donator", 	color = Color( 171, 0, 255, 255 ) },
--	["bossdonator"] = { name = "Boss Donator", 	color = Color( 236, 236, 236, 255 ) },
...
function SGS_CheckTimeForDay( time )
	...
	if !time then return "Sunday" end
