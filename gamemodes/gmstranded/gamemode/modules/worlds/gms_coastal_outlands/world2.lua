local world = {}
world.Name		= "Canyon World"
world.SkyPos 	= -8000
world.Bounds	= {
	[1] = {
		Min = Vector( -2673, -6443, -11512 ),
		Max = Vector( 8994, 15282, -7868 )
	},
}
world.Gravity		= 1.0
...
world.SkyObjects = {
	{
		...
		Orbit = { --Table of data about the planet's orbit in the sky
			Radius = 20, --Distance from the planet to the world center
