...
function GM.Tribes:GetPermissionType( t_id )
	if !self:IsValid( t_id ) then return nil end
...
function GM.Tribes:GetTribeLevel( ply )
	local t_id = self:GetPlayersTribe( ply )
	if !self:IsValid( t_id ) then return 0 end
...
GM.Tribes.LevelPerks = {
	...
	[8] = {
		name 	= 	"Experience Boost 2 & Tribe Cache Capacity Upgrade",
		desc 	= 	"Permanent increase of total experience earned by 20%. Tribe cache capacity increased by 2500",
	},
	[9] = {
	...
	[10] = {
		name 	= 	"Bartering & Tribe Cache Capacity Upgrade",
		desc 	= 	"Vorty will sell you items for 10% cheaper. Tribe cache capacity increased by 2500",
	},
}
