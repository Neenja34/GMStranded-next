...
function ENT:Summon()
	...
	if game.GetMap() == "gms_coastal_outlands" then
		SGS_MakeCreature("npc_antlionguard", self:GetPos() + Vector(0, 0, 10), nil)
		for k, v in pairs(player.GetAll()) do
			v:SendMessage(self:GetNWEntity("OwnerObj", false):Name() .. " spawned an antlion boss in: " .. GAMEMODE.Worlds:GetEntityWorldSpace(self).Name, 60, Color(255, 255, 0, 255))
		end
	else
